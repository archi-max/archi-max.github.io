...
<div className="not-prose grid gap-4 my-8">
  <article className="card-blog">
    <p className="text-xs uppercase tracking-wide mb-2" style={{ color: "hsl(var(--text-subtle))" }}>New</p>
    <a href={`${globalThis.__SCRATCH_BASE__ || ''}/posts/lesswrong-engineering-principles/`} className="block space-y-2 group">
      <h2 className="font-display text-2xl group-hover:text-primary transition-colors" style={{ color: "hsl(var(--text-heading))" }}>
        LessWrong-inspired principles for engineering work
      </h2>
      <p className="text-sm" style={{ color: "hsl(var(--text-body))" }}>Rationality-flavored heuristics for calmer, more reliable delivery.</p>
      <p className="text-xs" style={{ color: "hsl(var(--text-subtle))" }}>Feb 2025 · 7 min read · Engineering</p>
    </a>
  </article>

  <article className="card-blog">
    <p className="text-xs uppercase tracking-wide mb-2" style={{ color: "hsl(var(--text-subtle))" }}>Featured</p>
    <a href={`${globalThis.__SCRATCH_BASE__ || ''}/posts/welcome-to-the-blog/`} className="block space-y-2 group">
      <h2 className="font-display text-2xl group-hover:text-primary transition-colors" style={{ color: "hsl(var(--text-heading))" }}>
        Welcome to the Scratch-powered blog
      </h2>
      <p className="text-sm" style={{ color: "hsl(var(--text-body))" }}>How the MDX pipeline works, how to add posts, and why we kept the LessWrong aesthetic.</p>
      <p className="text-xs" style={{ color: "hsl(var(--text-subtle))" }}>Jan 2025 · 6 min read · Systems</p>
    </a>
  </article>
</div>
